...
- **Arbiter Emblem** = Spatula + Negatron Cloak
- **Archangel's Staff** = Needlessly Large Rod + Tear of the Goddess
- **Bastion Emblem** = Frying Pan + Chain Vest
...
- **Brawler Emblem** = Frying Pan + Giant's Belt
- **Challenger Emblem** = Frying Pan + Recurve Bow
- **Crownguard** = Needlessly Large Rod + Chain Vest
- **Dark Star Emblem** = Spatula + B.F. Sword
...
- **Kraken's Fury** = Negatron Cloak + Recurve Bow
- **Last Whisper** = Recurve Bow + Sparring Gloves
- **Marauder Emblem** = Frying Pan + B.F. Sword
- **Meeple Emblem** = Spatula + Chain Vest
- **Morellonomicon** = Needlessly Large Rod + Giant's Belt
- **N.O.V.A. Emblem** = Spatula + Sparring Gloves
- **Nashor's Tooth** = Recurve Bow + Giant's Belt
- **Primordian Emblem** = Spatula + Giant's Belt
...
- **Rogue Emblem** = Frying Pan + Sparring Gloves
- **Shepherd Emblem** = Frying Pan + Tear of the Goddess
- **Space Groove Emblem** = Spatula + Tear of the Goddess
- **Spear of Shojin** = B.F. Sword + Tear of the Goddess
- **Spirit Visage** = Tear of the Goddess + Giant's Belt
- **Stargazer Emblem** = Spatula + Needlessly Large Rod
...
- **Tactician's Cape** = Spatula + Frying Pan
- **Tactician's Crown** = Spatula + Spatula
- **Tactician's Shield** = Frying Pan + Frying Pan
- **Thief's Gloves** = Sparring Gloves + Sparring Gloves
- **Timebreaker Emblem** = Spatula + Recurve Bow
- **Titan's Resolve** = Chain Vest + Recurve Bow
- **Vanguard Emblem** = Frying Pan + Negatron Cloak
